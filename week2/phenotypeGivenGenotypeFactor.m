...
%indexGene = AssignmentToIndex(assignments(:, 2), length(alphaList));
%indexFlag = AssignmentToIndex(assignments(:, 1), 2);
%flag = [1, 0]
%phenotypeFactor.val = flag(indexFlag).* alphaList(indexGene) + (1-flag(indexFlag)).*(1-alphaList(indexGene))
